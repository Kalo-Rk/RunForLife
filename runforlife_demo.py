...
# =-=-= Agents définis par l'utilisateur :
...
class Hunter(Agent):
    ...
    def move(self, grid, agents):
        ...
        #Instinct de Chasseur, ils seront attiré par les Coureurs dans leurs zones de vision : 
...
class Runner(Agent):
    ...
    def move(self, grid, agents):
        ...
        #Les Chasseur, le Feu de forêt et le froid éliminent les Coureurs :
        ...
        #Les arbres protegent les Coureurs : 
        ...
        #Coureur intelligent (smart), fuit et peut placer des Feux de camps dans la zone 3 :
                ...
                if (current_cell == ICE1) or (current_cell == ICE2) :
                    if self.fc == 1 :
                        if random.random() < 0.001 : 
                            # Rayon du cercle de lumière (diamètre 16, donc rayon = 8)
                            rayon = 8
        ...
        #Sur une pente(slope),la vitesse des Coureurs /2 en raison de la difficulté de la zone : 
        ...
        #Dans une vallée, la vitesse des Coureurs / 3 : 
...
# =-=-= Automates callulaires définis par l'utilisateur :
...
def init_simulation(params):
    ...
    #Generation aleatoire des Valley : 
    while (nbValley < 1500): 
    ...
    #Ajout des Slope autour des Valley : 
    for x in range(dx): 
        for y in range (dy):
    ...
    # Rayon du cercle de lumière emis par le feu de camp (diamètre 16, donc rayon = 8)
    rayon = 8
...
@njit(cache=True) # A suprimer sur gedit en cas d'erreur
